...
# WR-05: the ${VAR:+...} form omits the leading ':' entirely when
# LD_LIBRARY_PATH is unset (the common case) -- a bare trailing colon
# expands to an empty path component, which the dynamic linker treats
# as the current working directory (classic empty-path search order
